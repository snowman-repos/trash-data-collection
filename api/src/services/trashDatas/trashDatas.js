...
- There may be a weight specified for an item that cannot be associated with any specific category. Such weights will usually be followed by a unit of weight measurement like "kg", "kilos", or "kilogram". You should take this number, convert it to a floating point number, and append the number to the array value for the "otherWeights" property. The name of the item and only the item name should be appended to the array value for the "other" property. For example, a transcript containing "300kg rope" or "rope 300 kilos" Should result in the array value for the "otherWeights" property equal to [300.0] and the array value for the "other" property equal to ["rope"].
